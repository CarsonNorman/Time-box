...
function TaskForm(props) {
    ...
    return ( 
        ...
        <form id='taskForm' >
            ...
            <select name="timeStart" id="starting" onChange={props.handleChange}>
                <option value={minutes >= 45? (hours + 1) + ':' + (minutes - 45): hours + ':' + (minutes + 15)}>{minutes >= 45? (hours + 1) + ':' + (minutes - 45): hours + ':' + (minutes + 15)}</option>
